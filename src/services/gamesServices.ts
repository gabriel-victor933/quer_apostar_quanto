...
async function getGames(finished?: boolean,page?: number,homeTeamName?: string, awayTeamName?: string){
    const games = await gamesRepositories.getGames(finished,page,homeTeamName,awayTeamName)
    return games
}
